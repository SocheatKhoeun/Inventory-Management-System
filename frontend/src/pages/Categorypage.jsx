...
function Categorypage() {
  const { getallCategory, iscreatedCategory, searchdata, isLoading } =
    ...
    <div className="bg-base-100 min-h-screen">
      ...
      <div className="flex">
        ...
        <button
          ...
          className="bg-blue-800 ml-10 mt-20 text-white w-40 h-12 rounded-lg flex items-center justify-center"
        >
      ...
      {isFormVisible && (
        <div className="absolute top-10 bg-gray-100 right-0 h-svh p-6 border-2 border-gray-300 rounded-lg shadow-md transition-transform transform">
          ...
          <form onSubmit={submitCategory}>
            ...
            <button
              type="submit"
              className="bg-blue-800 text-white w-full h-12 rounded-lg hover:bg-blue-700 mt-4 disabled:bg-gray-500"
              disabled={isLoading}
            >
              {isLoading
                ? "Processing..."
