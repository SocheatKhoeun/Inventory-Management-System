  ...
  const onSubmit = (data) => {
    ...
    dispatch(login(data))
      ...
      .then((res) => {
        ...
        if (role === "staff") {
          navigator("/StaffDashboard", { replace: true });
        } else if (role === "admin") {
          navigator("/AdminDashboard", { replace: true });
        } else {
          navigator("/ManagerDashboard", { replace: true });
        }
      })
      .catch((error) => {
        ...
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center mb-6">
              ...
              <label htmlFor="2fa" className="text-gray-600 text-sm">
