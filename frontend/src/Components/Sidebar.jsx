...
function Sidebar() {
  ...
  return (
    <div className="flex flex-col w-64 text-black min-h-screen p-6 shadow-lg ">
      <h1 className="text-2xl font-bold text-center text-gray-700 mb-10">
        {" "}
        <img src={logo1} className="w-56 bg-white" alt="sample logo"></img>
      </h1>
      ...
      <nav className="space-y-4">
        ...
        {Authuser?.role === "manager" && (
          <ul className="space-y-2">
            ...
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
              ...
              <Link to="/ManagerDashboard/stock-transaction">
                Stock Transaction
              </Link>
            </li>
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
              <IoNotificationsOutline className="text-xl" />
              <Link to="/ManagerDashboard/NotificationPageRead">
                Notifications
              </Link>
            </li>
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
        ...
        {Authuser?.role === "admin" && (
          <ul className="space-y-2">
            ...
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
              <RiStockLine className="text-xl" />
              <Link to="/AdminDashboard/stock-transaction">
                Stock Transaction
              </Link>
            </li>
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
        ...
        {Authuser?.role === "staff" && (
          <ul className="space-y-2">
            ...
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
              <RiStockLine className="text-xl" />
              <Link to="/StaffDashboard/stock-transaction">
                Stock Transaction
              </Link>
            </li>
            <li className="flex items-center space-x-3 text-gray-700 hover:text-blue-700 cursor-pointer p-2 rounded-md transition">
              <IoNotificationsOutline className="text-xl" />
              <Link to="/StaffDashboard/NotificationPageRead">
                Notifications
              </Link>
            </li>
          </ul>
