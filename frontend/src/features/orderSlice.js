  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(gettingallOrder.fulfilled, (state, action) => {
        ...
        // Handle both wrapped (orders array) and unwrapped responses
        state.getorder = Array.isArray(action.payload)
          ? action.payload
      ...
      .addCase(createdOrder.fulfilled, (state, action) => {
        ...
        // Add new order to the list if it exists
        if (action.payload && state.getorder) {
