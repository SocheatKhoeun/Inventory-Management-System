  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(gettingallproducts.fulfilled, (state, action) => {
        ...
        // Handle both wrapped (Products key) and unwrapped (direct array) responses
        state.getallproduct = action.payload?.Products || action.payload || [];
      })
      ...
      .addCase(Addproduct.fulfilled, (state, action) => {
        ...
        // Add new product to the list (populate it if needed)
        if (action.payload) {
          state.getallproduct = [
            ...(state.getallproduct || []),
            action.payload,
