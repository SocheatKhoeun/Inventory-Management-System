  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(staffUser.fulfilled, (state, action) => {
        // Ensure we always have an array, not a message object
        state.staffuser = Array.isArray(action.payload) ? action.payload : [];
      })
      ...
      .addCase(managerUser.fulfilled, (state, action) => {
        // Ensure we always have an array, not a message object
        state.manageruser = Array.isArray(action.payload) ? action.payload : [];
      })
      ...
      .addCase(adminUser.fulfilled, (state, action) => {
        // Ensure we always have an array, not a message object
        state.adminuser = Array.isArray(action.payload) ? action.payload : [];
      })
      ...
      .addCase(removeusers.fulfilled, (state, action) => {
        // Refresh all user lists after successful removal
        // The parent component will dispatch new requests
      })

      .addCase(removeusers.rejected, (state, action) => {
        console.error("Remove user error:", action.payload);
      });
  },
});
