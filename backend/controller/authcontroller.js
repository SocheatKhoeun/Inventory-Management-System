...
module.exports.signup = async (req, res) => {
  try {
    // Log the incoming payload for debugging signup 400s
    console.log("Signup request body:", req.body);
    const { name, email, password, ProfilePic, role } = req.body;

    // Basic validation to help frontend debugging
    ...
    // Return 500 for unexpected errors and include message to help frontend debugging
    res
      .status(500)
      .json({
        error:
